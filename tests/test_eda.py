...
class TestSurveyEDA:
    ...
    def test_plot_likert_distribution(self, clean_survey_df, likert_columns, tmp_dir):
    ...
    def test_plot_correlation_heatmap(self, clean_survey_df, likert_columns, tmp_dir):
        import matplotlib.pyplot as plt
    ...
    def test_plot_demographic_breakdown_bar(self, clean_survey_df, tmp_dir):
        import matplotlib.pyplot as plt
    ...
    def test_plot_demographic_breakdown_pie(self, clean_survey_df, tmp_dir):
        import matplotlib.pyplot as plt
    ...
    def test_missing_data_report_with_missing(self, sample_survey_df, tmp_dir):
        import matplotlib.pyplot as plt
